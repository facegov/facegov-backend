...
```bash
my-first-lamdba-sam-app$ sam build
```
...
```bash
my-first-lamdba-sam-app$ sam logs -n StockCheckerFunction --stack-name my-first-lamdba-sam-app --tail
```
...
```bash
my-first-lamdba-sam-app$ cd functions/<function-name>/
...
```bash
sam delete --stack-name my-first-lamdba-sam-app
```
